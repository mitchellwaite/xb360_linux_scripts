...
pacstrap -KMPC ~/pacman360.conf /mnt/archpower base archpower-keyring linux-xenon networkmanager vim nano less wget openssh fastfetch jwm xorg-xinit xorg-xterm xorg-server
